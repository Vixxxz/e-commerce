...
public class ControleCliente extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        Resultado<Cliente> resultadoClienteFiltro = extrairClienteFiltro(req);
        ...
        Cliente clienteFiltro = resultadoClienteFiltro.getValor();
        Resultado<List<EntidadeDominio>> resultadoConsultaCliente = fachada.consultar(clienteFiltro);

        if (!resultadoConsultaCliente.isSucesso()) {
            resp.setStatus(HttpServletResponse.SC_BAD_REQUEST);
            JsonObject resposta = new JsonObject();
            resposta.addProperty("erro", "{\"erro\": \"" + resultadoConsultaCliente.getErro() + "\"}");
            out.print(gson.toJson(resposta));
            return;
        }

        String json = gson.toJson(resultadoConsultaCliente.getValor());
    ...
    private Resultado<Cliente> extrairClienteFiltro(HttpServletRequest req) {
        Cliente clienteFiltro = new Cliente();
        ...
        return Resultado.sucesso(clienteFiltro);
    }
}
